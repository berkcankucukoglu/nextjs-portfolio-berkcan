...
export const EXPERIENCES = [
  {
    ...
    description: `Worked as a full-stack developer on the sigortalarburada.com project, an insurance platform built to improve user experience, simplify policy management, and make it easier for users to receive insurance offers from multiple companies.`,
    technologies: [
      'C#',
      '.NET Core',
      'Vue.js',
